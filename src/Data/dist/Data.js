...
exports.contactDescription = exports.workArray = exports.timeLineArray = exports.aboutSecondryContent = exports.aboutPrimaryContent = exports.homeDescription = exports.outerLinkArray = exports.outlinkBottomArray = exports.navItemsArray = void 0;
exports.navItemsArray = ['home', 'about', 'experience', 'work', 'contact'];
exports.outlinkBottomArray = [
    {
        label: 'Linkedin',
        icon: />,,
...
];
{
    color: 'rgb(59 62 66)',
        url;
    'https://Github.com/JeffLiusGitHub ',
        name;
    'Github',
        children;
    size;
...
}
{
    color: 'rgb(111 194 176)',
        url;
    'mailto:jeffliu2802@hotmail.com',
        name;
    'Mail',
        children;
    size;
...
;
exports.homeDescription = 'As a passionate developer, I switched my career from an aircraft engineer to a full-stack developer. I have experience working with React, Typescript, Redux, Styled-Component, React Testing Library, Restful Api, Material UI, github and Node JS. You can directly view my work or browsing my past experience.';
exports.aboutPrimaryContent = 'Hi. I`m Jeff, nice to meet you. Please take a look around.';
exports.aboutSecondryContent = ' With an eye for details and good time management, I am a passionate and quality-oriented developer with extensive experience in web development. An effective communicator and a good team player with can-do attitude. As a developer, I am a quick learner, eager to keep up with the latest technology. I am currently pursuing a full-time career with in developer opportunities.';
exports.timeLineArray = [
    {
        id: 1,
        align: 'right',
...
exports.contactDescription = 'Feel free to contact me if you are interested in my work, skills or would like to speak with me. You can find my Linkedin, Github, Email and resume by clicking the link below. Let`s keep in touch!';
